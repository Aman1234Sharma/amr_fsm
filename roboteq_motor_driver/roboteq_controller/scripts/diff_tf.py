...
class DiffTf(Node):
    ...
    def __init__(self):
        ...
        self.ticks_meter = float(
            self.declare_parameter('ticks_meter', 568).value)  # The number of wheel encoder ticks per meter of travel
    ...
    def update(self):
       ...
       # self.odom_broadcaster.sendTransform(transform_stamped_msg)  # this line publishes tf
